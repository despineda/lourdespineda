    ...
    <div class="row">
        <div class="col-md-8 col-md-offset-2">
            ...
            <div class="panel panel-default">
                <div class="panel-heading" id="title3">Profile</div>
                ...
                <div class="panel-body">
                    <form class="form-horizontal" method="POST" action="{{ url('/addProfile') }}" enctype="multipart/form-data">
                        ...
                        <div class="form-group{{ $errors->has('profile_pic') ? ' has-error' : '' }}">
                            <label for="profile_pic" class="col-md-4 control-label">Image</label>
                        ...
                        <div class="form-group">
                            <div class="col-md-8 col-md-offset-4">
                                <button type="submit" class="btn4 btn-primary btn-lg">
                                    Upload
                                </button>
                            </div>
                        </div>
