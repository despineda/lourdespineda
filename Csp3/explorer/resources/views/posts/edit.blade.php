            ...
            <div class="panel panel-default">
                ...
                <div class="panel-body">
                    <div class="row">
                        ...
                        <div class="form-group{{ $errors->has('post_body2') ? ' has-error' : '' }}">
                        <div class="form-group{{ $errors->has('post_body3') ? ' has-error' : '' }}">
                            ...
                            <div class="col-md-7">                                
                                ...
                                <hr class="hr">
                                <textarea id="email" rows="7" class="form-control" name="post_body2" required>{{ $posts->post_body2 }}</textarea>

                                <hr class="hr">
                                <textarea id="email" rows="7" class="form-control" name="post_body3" required>{{ $posts->post_body3 }}</textarea>
                        ...
                        <div class="form-group{{ $errors->has('category_id') ? ' has-error' : '' }}">
                            ...
                            <!-- edit post.. get saved data from database  -->
                            <div class="col-md-7">
                    ...
                    <!-- posting image -->
                        ...
                        <div class="form-group">
                            <div class="col-md-2 col-md-offset-4">
                                <button type="submit" class="btn3 btn-primary btn-large btn-block">
                                    Update Post
                                </button>
                            </div>
                        </div>
